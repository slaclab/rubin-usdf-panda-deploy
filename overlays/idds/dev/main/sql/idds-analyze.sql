 ...
 analyze partman.template_doma_idds_contents_ext;
 ...
 analyze doma_idds.contents_p0;
 analyze partman.custom_time_partitions;
 analyze partman.part_config;
 analyze partman.part_config_sub;
 analyze partman.template_doma_idds_contents;
 analyze doma_idds.contents_ext_p1000;
 analyze doma_idds.alembic_version;
 analyze doma_idds.meta_info;
 analyze doma_idds.processings;
 analyze doma_idds.contents_p1000;
 analyze doma_idds.transforms;
 analyze doma_idds.contents_p2000;
 analyze doma_idds.contents_ext_p0;
 analyze doma_idds.conditions;
 analyze doma_idds.contents_p3000;
 analyze doma_idds.contents_default;
 analyze doma_idds.contents_ext_p2000;
 analyze doma_idds.contents_ext_p3000;
 analyze doma_idds.contents_ext_default;
